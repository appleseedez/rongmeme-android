...
public final class DateParser {
    ...
    private static String[] additionalMasks;

    static {
        // ADDITIONAL_MASKS = PropertiesLoader.getPropertiesLoader().getTokenizedProperty("datetime.extra.masks","|");
        additionalMasks = new String[] {"HH:mm yyyy/MM/dd","yyyy-MM-dd HH:mm:ss","yyyy-MM-dd HH:mm"};
    }
    ...
    private static final String[] W3CDATETIME_MASKS = {"yyyy-MM-dd'T'HH:mm:ss.SSSz","yyyy-MM-dd't'HH:mm:ss.SSSz",
            ...
            "yyyy-MM-dd't'HH:mm:ssz","yyyy-MM-dd'T'HH:mm:ss'Z'","yyyy-MM-dd't'HH:mm:ss'z'",
    ...
    /**
     * The masks used to validate and parse the input to this Atom date. These are a lot more forgiving than what the
     * Atom spec allows. The forms that are invalid according to the spec are indicated.
     */
    ...
    public static Date parseDate(String sDate) {
        ...
        if (d == null) {
            d = parseRFC822(sDate);
            if (d == null && additionalMasks.length > 0) {
