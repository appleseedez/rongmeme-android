 ...
 * @since 1.0
 */
public class CleaningAppointmentResult implements java.io.Serializable {
    ...
    public CleaningItemVO getBody() {
        return body;
    }

    public void setBody(CleaningItemVO body) {
        this.body = body;
    }
