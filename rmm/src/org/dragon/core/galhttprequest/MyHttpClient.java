...
/**
 * 定制自己的HttpClient,确保唯一实例，提供全局访问接口 自定义timeout时间等参数
 */
public final class MyHttpClient {
    ...
    /**  TYPE_NET_WORK_DISABLED : 网络不可用 */
    public static final int TYPE_NET_WORK_DISABLED = 0;
    /**  TYPE_CM_CU_WAP : 移动联通wap10.0.0.172 */
    public static final int TYPE_CM_CU_WAP = 4;
    /**  TYPE_CT_WAP : 电信wap 10.0.0.200 */
    public static final int TYPE_CT_WAP = 5;
    /**  TYPE_OTHER_NET : 电信,移动,联通,wifi 等net网络 */
    ...
    public static HttpClient getNewInstance(Context mContext) {
        ...
        /*
         * 1.set a timeout for the connection manager,it defines how long we should wait to get a connection out of the
         * connection pool managed by the connection manager
         */
        ConnManagerParams.setTimeout(params, 5000);

        /*
         * 2.The second timeout value defines how long we should wait to make a connection over the network to the
         * server on the other end
         */
        HttpConnectionParams.setConnectionTimeout(params, TIMEOUT);

        /*
         * 3.we set a socket timeout value to 4 seconds to define how long we should wait to get data back for our
         * request.
         */
        ...
        if (checkNetworkType(mContext) == TYPE_CT_WAP) {
        ...
        if (checkNetworkType(mContext) == TYPE_CM_CU_WAP) {
            // 通过代理解决中国移动联通GPRS中wap无法访问的问题
     ...
     * @param paramHttpUriRequest HttpUriRequest
     * @return HttpResponse
     * @throws IOException IO exception
     */
    public static HttpResponse execute(Context context, HttpUriRequest paramHttpUriRequest) throws IOException
            {
                ...
                if (netType == ConnectivityManager.TYPE_WIFI) {
                    ...
                    if (c != null) {
                        ...
                        if (!TextUtils.isEmpty(user)) {
                            LogUtil.i("", "=====================>代理：" + c.getString(c.getColumnIndex("proxy")));
