...
public class CleaningAppointmentForm implements java.io.Serializable {
    ...
    public CleaningAppointmentForm(Head head,long storeid, String servicetype, String storename, double allprice, long userid,
            String name, String phone, String address, String source, List<CleaningAppointmentItemForm> services) {
        this.head = head;
